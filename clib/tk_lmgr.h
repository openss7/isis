...
extern int log_in_replay;		/* Flag for testing if a process is in the middle of
					   replaying its logs */
...
extern log_nod *log_init(		/* char *fname, *gname, int replay_entno, flush_type, int
					   (*end_of_replay)() */ );
...
extern int log_write_msg( /* ginfo *gip, message *msg, int entry */ );
