	...
	va_dcl
{
	...
	va_start(ap);
	BEGINFROMFORTRAN rval = do_bcast(CL_ABCAST, "", &ap);
	...
	va_dcl
{
	...
	va_start(ap);
	BEGINFROMFORTRAN rval = do_bcast(CL_CBCAST, "", &ap);
	ENDFROMFORTRAN va_end(ap);
	...
	va_dcl
{
	...
	va_start(ap);
	BEGINFROMFORTRAN rval = do_bcast(CL_FBCAST, "", &ap);
	ENDFROMFORTRAN va_end(ap);
	...
	va_dcl
{
	...
	va_start(ap);
	BEGINFROMFORTRAN rval = do_bcast(CL_GBCAST, "", &ap);
	ENDFROMFORTRAN va_end(ap);
