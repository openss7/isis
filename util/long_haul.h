...
#define messDesc_format             'z'	/* Character format for the messDesc type (used in
					   pc_bcast) */
...
#define MAX_FILE_NAME              128	/* Used by the file transfert protocol (right value to be
					   defined) */
...
struct rcvFileDesc {
	...
	message *lh_msg;		/* Holds the initial message until all the file has been
					   received */
