...
update()
{
	...
	begin {
		...
		case AB_MODE:
			abcast(gaddr, RECEIVE, "%l%l%l%l", x, y, op, arg, use_rpc ? ALL : 0, "%d",
			       rval);
			break;

		case CB_MODE:
			cbcast(gaddr, RECEIVE, "%l%l%l%l", x, y, op, arg, use_rpc ? ALL : 0, "%d",
			       rval);
			break;

		case FB_MODE:
			fbcast(gaddr, RECEIVE, "%l%l%l%l", x, y, op, arg, use_rpc ? ALL : 0, "%d",
			       rval);
			break;

		case MB_MODE:
			mbcast(gaddr, RECEIVE, "%l%l%l%l", x, y, op, arg, use_rpc ? ALL : 0, "%d",
			       rval);
			break;

		case GB_MODE:
			gbcast(gaddr, RECEIVE, "%l%l%l%l", x, y, op, arg, use_rpc ? ALL : 0, "%d",
			       rval);
			break;
